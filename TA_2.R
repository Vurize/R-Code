...
# dis = read_xlsx("D:/Users/ASUS/Documents/PDF Files/Tugas Akhir/Referensi/Dampak bencana alam terhadap volatilitas saham perusahaan PnC di Australia/australia dis.xlsx")
# dis$`Start Date` = as.Date(dis$`Start Date`)
